...
<form>
    ...
    <div class="cliente">
        ...
        <div class="footer row">
            ...
            <div class="content-date">
                <label>Fecha: </label>
                <input type="date" class="field-custom" disabled value="{{$form->customer_date}}" name="customer_date">
            </div>
        </div>
    </div>
    <div class="pss">
    ...
    <div class="actions row">
        <div class="col-md-1 col-sm-12">
            <a href="/list" class="btn btn-success"> << REGRESAR</a>
        </div>
        <div class="col-md-4 col-sm-12"></div>
            <a href="/downloadPDF/{{$form->id}}" class="btn btn-primary active"> GENERAR PDF</a>
        </div>
    </div>
